...
base = Tk()
base.title("HOSTEL ACCOMMODATION SYSTEM")
base.geometry(f'{1535}x{790}+{0}+{0}')
heading = Label(base, text="HOSTEL ACCOMMODATION SYSTEM", font=("Arial 30 bold"), bg="lightseagreen", fg="white", padx=490, pady=20)
heading.pack()
...
def login():
    ...
    if id == "anshikamishra9336@gmail.com" and key == "2004":
        main()
    else:
        user_entry.focus()
